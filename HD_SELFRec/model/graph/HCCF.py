...
'''
python main.py --model=HCCF --dataset=ml-1m  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.1 --cl_rate=1e-04 --temp=0.2 --reg=0.1 --early_stopping_steps=20 --seed=20
python main.py --model=HCCF --dataset=amazon_books  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.1 --cl_rate=1e-04 --temp=0.2 --reg=0.1 --early_stopping_steps=20 --seed=20
python main.py --model=HCCF --dataset=steam  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.1 --cl_rate=1e-04 --temp=0.2 --reg=0.1 --early_stopping_steps=20 --seed=20
python main.py --model=HCCF --dataset=yelp  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.1 --cl_rate=1e-04 --temp=0.2 --reg=0.1 --early_stopping_steps=20 --seed=20
'''
