...
'''
python main.py --model=DHCF --dataset=amazon_books  --lrate=0.0001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.1 --cl_rate=1e-05 --temp=0.2 --reg=0 --early_stopping_steps=20 --seed=100
python main.py --model=DHCF --dataset=steam  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.0001 --cl_rate=1e-05 --temp=0.2 --reg=0 --early_stopping_steps=20 --seed=100
python main.py --model=DHCF --dataset=yelp  --lrate=0.0001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.001 --cl_rate=1e-05 --temp=0.2 --reg=0 --early_stopping_steps=20 --seed=100
'''
