...
'''
python main.py --model=SGL --dataset=lastfm  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0 --early_stopping_steps=20 --seed=123
python main.py --model=SGL --dataset=amazon_books  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0 --early_stopping_steps=20 --seed=123
python main.py --model=SGL --dataset=steam  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0 --early_stopping_steps=20 --seed=123
python main.py --model=SGL --dataset=yelp  --lrate=0.001 --weight_decay=5e-6 --drop_rate=0.5 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0 --early_stopping_steps=20 --seed=123
'''
