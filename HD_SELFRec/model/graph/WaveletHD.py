...
- replaced HGConv(in SelfawareEncoder) 
- with Hypergraph Diffusion(original EDHNN with HConv) EquivSetGNN2(one channel only)
python main.py --model=WaveletHD --dataset=lastfm  --lrate=0.01 --weight_decay=5e-6 --drop_rate=0.2 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0.1 --early_stopping_steps=20  --seed=100 --mode=woglobal
'''
import time
