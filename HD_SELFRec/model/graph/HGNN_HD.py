...
- python main.py --model=HGNN_HD --dataset=lastfm  --lrate=0.01 --weight_decay=5e-6 --drop_rate=0.2 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0.2 --early_stopping_steps=20  --seed=20 --mode=woglobal
- python main.py --model=HGNN_HD --dataset=ml-1m  --lrate=0.01 --weight_decay=5e-6 --drop_rate=0.2 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0.1 --early_stopping_steps=20  --seed=20 --mode=woglobal
- python main.py --model=HGNN_HD --dataset=amazon_books  --lrate=0.01 --weight_decay=5e-6 --drop_rate=0.2 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0.2 --early_stopping_steps=20  --seed=20 --mode=woglobal
'''
import time
...
- python main.py --model=HGNN_HD --dataset=amazon_books  --lrate=0.01 --weight_decay=5e-6 --drop_rate=0.2 --p=0.3 --cl_rate=1e-05 --temp=0.2 --reg=0.2 --early_stopping_steps=20  --seed=20 --mode=woglobal
'''
class HGNN_HD(GraphRecommender):
