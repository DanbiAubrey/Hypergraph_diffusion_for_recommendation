...
from model.layers.layers4 import EquivSetConv4
...
class EquivSetGNN4(nn.Module):
    def __init__(self, num_features, args, dense_hypergraph, data):
        ...
        self.conv = EquivSetConv4.EquivSetConv4(args['MLP_hidden'], args['MLP_hidden'], mlp1_layers=self.mlp1_layers, mlp2_layers=self.mlp2_layers,
