...
from model.layers.layers2 import EquivSetConv2
...
class EquivSetGNN(nn.Module):
    def __init__(self, num_features, args, dense_hypergraph, data):
        ...
        self.conv = EquivSetConv2.EquivSetConv(args['MLP_hidden'], args['MLP_hidden'], mlp1_layers=self.mlp1_layers, mlp2_layers=self.mlp2_layers,
